...
const SERVER_URL = 'https://nairobi-konnect-backend.onrender.com';
                ...
                <div className="flex flex-col items-center justify-center w-full p-12 bg-gray-800 rounded-l-lg md:w-2/3 lg:w-3/5 xl:w-2/3 lg:p-16 bg-opacity-90">
                    {!isLoggedIn ? (
                        <>
                            ...
                            <form onSubmit={handleSubmit(handleLogin)} className="flex flex-col w-full gap-6">
                                ...
                                <button type="submit" className="px-8 py-4 text-white transition-transform transform rounded-lg shadow-md bg-gradient-to-br from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 hover:scale-105">
                                    Login
                                </button>
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <button
                                ...
                                className="px-8 py-4 text-white transition-transform transform rounded-lg shadow-md bg-gradient-to-br from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 hover:scale-105"
                            >
                                Logout
                            </button>
                        </div>
