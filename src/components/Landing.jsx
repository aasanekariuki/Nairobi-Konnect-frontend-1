			...
			<section id="about" className="about">
				<div className="about-container">
					...
					<p className="about-description">
						NairobiKonnect is your gateway to discovering the best
						Nairobi has to offer. Whether you're booking a bus,
						shopping, or connecting with local businesses, we're
				...
				<div className="testimonials-container">
					...
					<div className="testimonial">
						<p className="testimonial-quote">
							"NairobiKonnect made my trip to Nairobi so easy and
							fun. Booking a bus was a breeze!"
						</p>
						<p className="testimonial-author">- Jane Doe</p>
					</div>
					<div className="testimonial">
						<p className="testimonial-quote">
							"As a business owner, I've reached more customers
				...
				<div className="locations-container">
					...
					<div className="location-grid">
						<div className="location-card">
							<img
								src="https://i.pinimg.com/236x/76/66/13/766613bbad01ba083be4ce56fe8dcff6.jpg"
								alt="Market Name"
						...
						<div className="location-card">
							<img
								src="https://i.pinimg.com/236x/c7/f9/d4/c7f9d44d724f0a35af544b45b53fa0ff.jpg"
								alt="maasai market"
								className="location-image"
							/>
							<h3 className="location-title">Maasai Market</h3>
							<p className="location-description">
								Experience the vibrant culture and crafts.
							</p>
						</div>
			...
			<section id="cta" className="cta">
				<div className="cta-container">
					<h2 className="cta-title">
						Join the NairobiKonnect Community
					</h2>
					<p className="cta-description">
						Sign up today and start exploring everything Nairobi has
						to offer.
					</p>
					<button
						onClick={() =>
			...
			<section id="storytelling" className="storytelling">
				<div className="storytelling-container">
					<h2 className="storytelling-title">
						Discover Nairobi Through Our Story
					</h2>
					<div className="storytelling-content">
						<div className="storytelling-item" id="culture">
							...
							<p className="storytelling-text">
								Explore Nairobi's rich cultural heritage through
								vibrant festivals, traditional music, and dance.
							</p>
						</div>
						<div className="storytelling-item" id="history">
							...
							<p className="storytelling-text">
								Journey through Nairobi's past with historical
								landmarks and fascinating stories of the city’s
								growth.
							</p>
						</div>
						<div className="storytelling-item" id="attractions">
							...
							<p className="storytelling-text">
								Discover Nairobi’s top attractions, from
								breathtaking parks to bustling markets and
								iconic landmarks.
							</p>
						</div>
					</div>
					...
					<div className="services-list">
						<div className="service-card">
							<div className="service-icon">
								...
								>
									<path
										d="M12 3v9.27l6.72 4.09 1.28-2.18-7.52-4.5L12 3z"
										fill="currentColor"
									/>
								</svg>
							</div>
							...
							<p className="service-description">
								Easily book buses for your desired routes with
								our user-friendly interface. Enjoy seamless
						...
						<div className="service-card">
							...
							<p className="service-description">
								Register your vehicle and start driving. Connect
								with passengers and manage your schedules
						...
						<div className="service-card">
							<div className="service-icon">
								...
								>
									<path
										d="M20 6h-8V4h8v2zm-2 8v2H4v-2h14zm0-8v2H4V6h14z"
										fill="currentColor"
									/>
								</svg>
							</div>
							...
							<p className="service-description">
								Shop from a variety of local stores with an easy
								and secure payment system. Discover unique
						...
						<div className="service-card">
							<div className="service-icon">
								...
								>
									<path
										d="M12 2L1 21h22L12 2zm0 3.27L17.64 18H6.36L12 5.27z"
										fill="currentColor"
									/>
								</svg>
							</div>
							...
							<p className="service-description">
								Expand your business by reaching more customers.
								List your products and services, and grow your
								presence in the Nairobi market.
							</p>
						</div>
					</div>
				</div>
